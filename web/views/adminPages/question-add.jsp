...
<div class="card">
    ...
    <form action="${pageContext.request.contextPath}/questions" method="post" id="form">
        ...
        <input minlength="3" maxlength="1900" id="Question" class="form-control" placeholder="<%=LocaleQuestion%>" type="text" name="text" required>
            <br>
        </div>
        <div class="mb-3">
            <label for="option1" class="form-label"><%=LocaleOption%>1</label>
        <input minlength="3" maxlength="1400" id="option1" class="form-control" placeholder="<%=LocaleOption%>1" type="text" name="option1" required>
        ...
        <input minlength="3" maxlength="1400" id="option2" class="form-control" placeholder="<%=LocaleOption%>2" type="text" name="option2" required>
            <div class="form-check">
        ...
        <input minlength="3" maxlength="1400" id="option3" class="form-control" placeholder="<%=LocaleOption%>3" type="text" name="option3" required>
            <div class="form-check">
        ...
        <input minlength="3" maxlength="1400" id="option4" class="form-control" placeholder="<%=LocaleOption%>4" type="text" name="option4" required>
            <div class="form-check">
