            ...
            <form action="${pageContext.request.contextPath}/users" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input minlength="3" maxlength="45" id="surname" class="form-control"
                           placeholder="<%=LocaleSurname%>" type="text" name="surname" value="${user.surname}" required><br>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label"><%=LocaleEmail%>
                    </label>
                    <input pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" maxlength="45" id="email" class="form-control"
                           placeholder="<%=LocaleEmail%>" type="text" name="email" value="${user.email}" required><br>
                </div>
                <div class="mb-3">
