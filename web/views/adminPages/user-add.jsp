...
<div class="card">
    ...
    <form action="${pageContext.request.contextPath}/users" method="post">
        ...
        <input minlength="3" maxlength="45" id="username" class="form-control" placeholder="<%=LocaleUsername%>" type="text" name="username" value="${user.username}" required><br>
        </div>
        <div class="mb-3">
            <label for="name" class="form-label"><%=LocaleName%></label>
        <input minlength="3" maxlength="45" id="name" class="form-control" placeholder="<%=LocaleName%>" type="text" name="name" value="${user.name}" required><br>
        </div>
        <div class="mb-3">
            <label for="surname" class="form-label"><%=LocaleSurname%></label>
        <input minlength="3" maxlength="45" id="surname" class="form-control" placeholder="<%=LocaleSurname%>" type="text" name="surname" value="${user.surname}" required><br>
        </div>
        <div class="mb-3">
