...
<div class="container pt-5">
    ...
    <div style="position: sticky; top: 0; z-index: 2" class="card align-items-center bg-white mb-5">
        ...
        <button onclick="buildForm()" class="btn btn-warning align-self-end" style="width: 100%">Submit test</button>
...
<form style="font-size: 16px; font-family: 'Montserrat'">
    ...
    <div class="container card question">
        ...
        <input class="question invisible">
        <div class="form-check d-flex align-items-center mb-2">
            <input class="form-check-input position-static mt-0 mr-2" type="checkbox" value="1" name="${question.id}">
            ${question.option1}
        </div>

        <div class="form-check d-flex align-items-center mb-2">
            <input class="form-check-input position-static mt-0 mr-2" type="checkbox" value="2" name="${question.id}">
            ${question.option2}
        </div>

        <div class="form-check d-flex align-items-center mb-2">
            <input class="form-check-input position-static mt-0 mr-2" type="checkbox" value="3"  name="${question.id}">
            ${question.option3}
        </div>

        <div class="form-check d-flex align-items-center mb-2">
            <input class="form-check-input position-static mt-0 mr-2" type="checkbox" value="4"  name="${question.id}">
            ${question.option4}
        </div>
    </div>
