...
<div class="card">
    ...
    <form action="${pageContext.request.contextPath}/users" method="post">
        ...
        <input minlength="3" maxlength="45" id="username" class="form-control" placeholder="username" type="text" name="username" required><br>
        </div>
        <div class="mb-3">
        ...
        <input minlength="3" maxlength="45" id="surname" class="form-control" placeholder="Surname" type="text" name="surname" required><br>
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Email</label>
        <input pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" maxlength="45" id="email" class="form-control" placeholder="Email" type="text" name="email" required><br>
        </div>
        <div class="mb-3">
