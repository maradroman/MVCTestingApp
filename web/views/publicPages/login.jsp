        ...
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/login" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input maxlength="45" minlength="1" id="password" class="form-control" placeholder="<%=LocalePassword%>" type="password" name="password"><br>
                    <%--                    <p class="text-info">*Minimum eight characters, at least one uppercase letter, one lowercase letter and one number</p>--%>
                </div>
                <input type="hidden" name="id" value="${user.id}">
                <button type="submit" class="btn btn-primary"><%=LocaleSignIn%></button>
            </form>
        </div>
    </div>
</div>
